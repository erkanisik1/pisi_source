...
[
    ...
    */
    ...
    'scripts' =>
    [   'jquery3'                    => 'https://code.jquery.com/jquery-3.3.1.min.js',
    ...
    */
    ...
    [
        ...
        'google'                  => 'https://fonts.googleapis.com/css?family=Open+Sans:400,700,800', 
        'jquery-confirm'          => 'https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.3.0/jquery-confirm.min.css',
    ],
