      ...
      <div class="my-3 my-md-5">
       ...
       <?php require('slider.php'); ?>
          ...
          <div class="row row-cards">
            <div class="col-md-12">
              <div class="card-body text-center">
                <h3 class="mb-3">PİSİ LİNUX ÖZELLİKLERİ</h3>
                <p class="mb-4">
                  Hızlı ve kararlı yapısıyla ve kullanıcı dostu pisilinux aileden biri gibidir. Kullandıkça seveceğiniz, vazgeçemeyeceğiniz ve gerçek türkçe dil desteği olan tek dağıtımdır.
                </p>
              </div>
            </div>
            ...
            <div class="col-md-6 col-xl-4">
              <div class="card">
                ...
                <div class="card-body">
                  PisiLinux ana dilimizi tamamıyla desteklemek için yoğun çaba gösterir. Depolardaki paketlerin Türkçe desteğine özen gösterir. Türkçe desteği vermeyen paketler için çeviri çalışmaları da yürütür. 
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-xl-4">
              <div class="card">
                ...
                <div class="card-body">
                  Pisilinux'ta KDE ile gelen KAPTAN sayesinde aklınızın sınırlarını aşan sayıda sınırsız kombinasyon ile bilgisayarınızı özelleştirebilir. Siz hayal edin KAPTAN yapsın.
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-xl-4">
              <div class="card">
                ...
                <div class="card-body">
                  PisiLinux'u kullanmak, hiç ummadağınız kadar kolay! Size sunulan ile yetinmeyin, hayal edebildiğiniz kadar geliştirin, kolaylıkla kullanın!
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-xl-4">
              <div class="card">
                ...
                <div class="card-body">
                  Virüsler ile başınız belada mı? Pisi Linux, alt yapsından aldığı güçle, Pisilinux'da virüslerin sisteminizi bozmasına asla izin vermez. 
                </div>
              </div>
            </div>
          </div>
          ...
          <!--blog start -->
          <div class="card-body text-center">
                <h3 class="mb-3">PİSİ LİNUX BLOG</h3>
                <p class="mb-4">
            ...
            <div class="col-sm-12 col-lg-4">
              <div class="card card-profile">
                ...
                <div class="card-body text-center" style="height: 213px;">
                  ...
                  <p class="mb-4"><?php echo Myfunc::kelimebol($key->content,200); ?>
                  </p>
                </div>
         </a>
              </div>
