	...
	class User_model extends Model{
		...
		function sifremiunuttum_model($post){
			...
			if (DB::affectedRows()) {
				...
				<br>
				<a href=\"http://pisilinux.org/member/yenisifre/$rnd\">Buraya tıklayarak yeni şifrenizi belirleyebilirsiniz.</a>";
							
				if (DB::affectedRows()){
					Email::sender('form@pisilinux.org', 'Pisilinux Üyelik İşlemleri')
					->receiver($post['email'])
