<?php if (!Session::select('username')) {redirect(URL::base('develop/user/login'));} ?>
    <!DOCTYPE html>
    ...
    <head>
        ...
        <link href="/<?php echo THEMES_DIR ?>develop/css/bootstrap.css" rel="stylesheet" />
       
        <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
        <link href="/<?php echo THEMES_DIR ?>develop/js/morris/morris-0.4.3.min.css" rel="stylesheet" />

        <link href="/<?php echo THEMES_DIR ?>develop/css/custom-styles.css" rel="stylesheet" />
        <link href='https://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
        <link rel="stylesheet" href="/<?php echo THEMES_DIR ?>develop/js/Lightweight-Chart/cssCharts.css"> 
        ...
        <div id="wrapper">
            <nav class="navbar navbar-default top-navbar" role="navigation">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/develop"><strong>Pisi Linux</strong></a>
                </div>
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><a href="<?php echo URL::base('/develop/user/logout'); ?>"><i class="fa fa-sign-out fa-fw"></i> Çıkış</a>
                            </li>
                        </ul>
                        <!-- /.dropdown-user -->
                    </li>
